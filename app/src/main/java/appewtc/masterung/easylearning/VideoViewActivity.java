...
public class VideoViewActivity extends AppCompatActivity {
    ...
    private void findPathVideo() {
        ...
        switch (positionAnInt) {
            case 1:
                pathVideoString = "android.resource://appewtc.masterung.easylearning/" + R.raw.video1;
                break;
            case 2:
                pathVideoString = "android.resource://appewtc.masterung.easylearning/" + R.raw.video2;
                break;
            case 3:
                pathVideoString = "android.resource://appewtc.masterung.easylearning/" + R.raw.video1;
                break;
